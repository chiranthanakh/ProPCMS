...
///////////////////////////////dashboard /////////////////////////////////////////////////////
    ...
    public void AverageMonthChart( ApiType apiTypes, MonthlyRevenueGraphrequest monthlyRevenueGraphrequest)
    {
        apiTypeVariable = apiTypes;
        Retrofit retrofit=getRetrofitClient(BaseUrl);
        ProPCms proPCms=retrofit.create(ProPCms.class);
    ...
    public void TopTenOutstandingList( ApiType apiTypes, MonthlyRevenueGraphrequest monthlyRevenueGraphrequest)
    {
        apiTypeVariable = apiTypes;
        Retrofit retrofit=getRetrofitClient(BaseUrl);
        ProPCms proPCms=retrofit.create(ProPCms.class);

        call=(Call<T>)proPCms.TopTenOutstanding(monthlyRevenueGraphrequest);
    ...
    public void OutstandingAgeingList( ApiType apiTypes, MonthlyRevenueGraphrequest monthlyRevenueGraphrequest)
    {
        apiTypeVariable = apiTypes;
        Retrofit retrofit=getRetrofitClient(BaseUrl);
        ProPCms proPCms=retrofit.create(ProPCms.class);

        call=(Call<T>)proPCms.OutstandingAgeingList(monthlyRevenueGraphrequest);
